...
export const chatTopics: ChatTopic[] = [
  {
    ...
    label: "Experience",
    openingAnswer:
      "I bring 15+ years across business systems, operations, software delivery, process improvement, and team leadership. My career moved from hands-on web development into software and systems analysis, technical operations, product operations, self-employed consulting and website work, and leadership roles where I coordinated people, process, and delivery.\n\nMy public resume includes self-employed consulting and website work from 2025 - Present, along with roles at GPARENCY, Eastern Union, CardCash, Central Analysis Bureau, and New York Guest Services. The throughline is practical execution: understanding the real problem, aligning technical and nontechnical contributors, and moving useful work forward.",
    followUps: [
